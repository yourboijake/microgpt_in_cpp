...
public:
  float data;
  float grad;
  Value(float dt, std::vector<std::shared_ptr<Value>> chn = {},
        std::vector<float> lgs = {});

  static std::shared_ptr<Value> add(std::shared_ptr<Value> a,
                                    std::shared_ptr<Value> b);

  static std::shared_ptr<Value> sub(std::shared_ptr<Value> a,
                                    std::shared_ptr<Value> b);

  static std::shared_ptr<Value> mult(std::shared_ptr<Value> a,
                                     std::shared_ptr<Value> b);

  static std::shared_ptr<Value> div(std::shared_ptr<Value> a,
                                    std::shared_ptr<Value> b);
